...
import com.github.sonarnext.api.utils.ISO8601;
...
public class SonarApiForm extends Form {

    public SonarApiForm() {
    }

    public SonarApiForm(MultivaluedMap<String, String> store) {
        super(store);
    }

    /**
     * Create a SonarApiForm instance with the "page", and "per_page" parameters preset.
     *
     * @param page the value for the "page" parameter
     * @param perPage the value for the "per_page" parameter
     */
    public SonarApiForm(int page, int perPage) {
        super();
     ...
     */
    public SonarApiForm withParam(String name, Object value) throws IllegalArgumentException {
     ...
     * @return this GitLabAPiForm instance
     */
    public SonarApiForm withParam(String name, Date date) throws IllegalArgumentException {
     ...
     */
    public SonarApiForm withParam(String name, Date date, boolean required) throws IllegalArgumentException {
     ...
     * @return this GitLabAPiForm instance
     */
    public <T> SonarApiForm withParam(String name, List<T> values) {
     ...
     * @throws IllegalArgumentException if a required parameter is null or empty
     */
    public <T> SonarApiForm withParam(String name, List<T> values, boolean required) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if a required parameter is null or empty
     */
    public SonarApiForm withParam(String name, Map<String, ?> variables, boolean required) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if a required parameter is null or empty
     */
    public SonarApiForm withParam(String name, Object value, boolean required) throws IllegalArgumentException {
